...
const TopBarDashboard = ({navbarButton}) => {
  ...
  return (
    ...
    <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center sm:justify-between">
        ...
        <div className="flex flex-row-reverse lg:flex-row gap-4 items-center w-full lg:w-auto">
        <button 
        id="navbarOpenButton"
        title="Sidebar"
        onClick={navbarButton}
        className="lg:hidden"><AiOutlineMenu className="text-xl" /></button>
          ...
          <button
            ...
            <IoIosAdd className='text-black text-2xl bg-white/10 rotate-45 rounded-full'/></button></>}
          </button>
